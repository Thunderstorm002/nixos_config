...
(setq user-full-name "Roshan Nair"
      user-mail-address "roshan.nair@protonmail.com")
...
(setq doom-font (font-spec :family "Inter Variable" :size 18)
      doom-variable-pitch-font (font-spec :family "Inter Variable" :size 20 :weight 'normal))
...
(defvar my-org-heading-colors
  '(:level-1 "#82AAFF"  ; Soft blue (inspired by ayu-dark's syntax)
    ...
    :level-6 "#89DDFF"  ; Cyan
    :level-7 "#80CBC4"  ; Teal
    :level-8 "#B0C4DE")) ; Light gray-blue
...
(after! org
  ...
  ;; Apply colors to headings from palette, keeping variable pitch
  (custom-set-faces!
    `(org-document-title :foreground ,(plist-get my-org-heading-colors :level-1) :height 1.5 :weight bold)
    `(org-level-1 :foreground ,(plist-get my-org-heading-colors :level-1) :height 1.4 :weight bold)
    `(org-level-2 :foreground ,(plist-get my-org-heading-colors :level-2) :height 1.3 :weight bold)
    `(org-level-3 :foreground ,(plist-get my-org-heading-colors :level-3) :height 1.2 :weight semi-bold)
    `(org-level-4 :foreground ,(plist-get my-org-heading-colors :level-4) :height 1.1 :weight semi-bold)
    `(org-level-5 :foreground ,(plist-get my-org-heading-colors :level-5) :height 1.0 :weight semi-bold)
...
;; Tags
  ...
  ;; Optional: Styled TODO keywords
  (setq org-todo-keyword-faces
        `(("TODO" . (:foreground ,(plist-get my-org-heading-colors :level-3) :weight bold))  ; Yellow for TODO
