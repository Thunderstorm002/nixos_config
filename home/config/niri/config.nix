...

{
  programs.niri.settings = {
    ...
    binds = {
      ...
      "Mod+Y".action.spawn = ["/run/current-system/sw/bin/cliphist list | /run/current-system/sw/bin/fuzzel --dmenu | /run/current-system/sw/bin/cliphist decode | /run/current-system/sw/bin/wl-copy"];
